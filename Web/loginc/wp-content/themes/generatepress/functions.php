...
{
	?>
	<span class="copyright"><?php _e('Copyright','generate');?> &copy; <?php echo date('Y'); _e(' log incorporated','generate'); ?></span>
	<!--
...
?>
	<style type="text/css">
		body.login div#login h1 a {
			...
			width:auto;
			height:50px;
			background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/admin/loginc.png);
			padding-bottom:0px;
			margin-bottom:0px;
		}
	</style>
